...
[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/kittuop00/Biolink)
...
```bash
# Clone the repo
git clone https://github.com/kittuop00/Biolink.git
cd Biolink
